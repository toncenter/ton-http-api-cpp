...
class GetAddressInformationHandler
    : public TonlibRequestHandler<schemas::v2::AddressInformationRequest, schemas::v2::AddressInformation> {
public:
  static constexpr std::string_view kName = "handler-GetAddressInformation";

  GetAddressInformationHandler(
    const userver::components::ComponentConfig& config, const userver::components::ComponentContext& context
  );

  td::Status ValidateRequest(const schemas::v2::AddressInformationRequest& request) const override;
  schemas::v2::AddressInformationRequest ParseTonlibGetRequest(
