...
class GetAddressStateHandler
    : public TonlibRequestHandler<schemas::v2::AddressStateRequest, schemas::v2::AddressState> {
public:
  static constexpr std::string_view kName = "handler-GetAddressState";

  GetAddressStateHandler(
    const userver::components::ComponentConfig& config, const userver::components::ComponentContext& context
  );

  td::Status ValidateRequest(const schemas::v2::AddressStateRequest& request) const override;
  schemas::v2::AddressStateRequest ParseTonlibGetRequest(
