...
ton_http::schemas::v2::MasterchainBlockSignaturesRequest ton_http::handlers::GetMasterchainBlockSignaturesHandler::ParseTonlibGetRequest(
...
td::Result<ton_http::schemas::v2::MasterchainBlockSignatures> ton_http::handlers::GetMasterchainBlockSignaturesHandler::HandleRequestTonlibThrow(
