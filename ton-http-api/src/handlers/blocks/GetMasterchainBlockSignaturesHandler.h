...
class GetMasterchainBlockSignaturesHandler : public TonlibRequestHandler<
                                               schemas::v2::MasterchainBlockSignaturesRequest,
                                               schemas::v2::MasterchainBlockSignatures> {
public:
  static constexpr std::string_view kName = "handler-GetMasterchainBlockSignatures";

  GetMasterchainBlockSignaturesHandler(
