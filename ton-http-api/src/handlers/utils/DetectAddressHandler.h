...
class DetectAddressHandler : public TonlibRequestHandler<schemas::v2::DetectAddressRequest, schemas::v2::DetectAddress> {
public:
  static constexpr std::string_view kName = "handler-DetectAddress";

  DetectAddressHandler(const userver::components::ComponentConfig& config, const userver::components::ComponentContext& context);
