...
std::int64_t userver::chaotic::convert::Convert(const std::string& value, chaotic::convert::To<std::int64_t>) {
  return std::int64_t{boost::lexical_cast<std::int64_t>(value)};
}
...
std::int64_t userver::chaotic::convert::
  Convert(const std::variant<std::string, std::int64_t>& value, chaotic::convert::To<std::int64_t>) {
  if (std::holds_alternative<std::string>(value)) {
      auto val = std::get<std::string>(value);
      return Convert(val, chaotic::convert::To<std::int64_t>{});
  }
